...
class Phone extends Field implements PreviewableFieldInterface
{
	...
	{
		return Craft::$app->getView()->renderTemplate('sproutfields/_fieldtypes/phone/settings',
			[
				'field' => $this,
			]);
	}
	...
	public function getInputHtml($value, ElementInterface $element = null): string
	{
		...
		return Craft::$app->getView()->renderTemplate('sproutfields/_fieldtypes/phone/input',
			[
				'id'    => $namespaceInputId,
				'name'  => $this->handle,
				'value' => $value,
